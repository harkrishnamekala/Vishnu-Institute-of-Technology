...
<div class="w3-main" style="margin-left:250px">
  ...
  Enter the Code here HK
  <form  action="uploadspec.php" method="post" enctype="multipart/form-data" style="margin-top: 100px">
    <input type="file" name="spec" />
    <input type="submit" name="fsubmit" />
  </form>

<!--<iframe src="uploads//files/" width="80%" height="600px"></iframe> -->
<?php
$id = $_SESSION['id'];
...
<p>
  The File should be not greater than 25MB
</p>
</div>
...
if(isset($_FILES['spec'])){
    // FIXME: The id should be string
    $id  = $_SESSION['id'];
    $file_size = $_FILES['spec']['size'];
    if($file_size > 250000000){
      echo "File is greater than 25mb";
    }else{
    $filename = $_FILES['spec']['name'];

    $directory  = "uploads/$id/files/";
